...
* [기레기 감시시스템, 1차 보고서와 설명][grassroots_media_monitoring_system]
  ([1][grassroots_media_monitoring_system_progress])

[grassroots_media_monitoring_system]: http://www.ddanzi.com/free/183551035
[grassroots_media_monitoring_system_progress]: https://www.clien.net/service/board/park/10781444
...
* (science bites) [guide to the science behind interstellar][guide_to_the_science_behind_interstellar] chapter 4-6
* (science bites) [a fortunate universe][a_fortunate_universe] chapter 2

link
* [Erik Demaine lecture videos][erik_demaine_videos]

[erik_demaine_videos]: https://www.youtube.com/results?search_query=Erik+Demaine

## May 24

reading
* (science bites) [guide to the science behind interstellar][guide_to_the_science_behind_interstellar] chapter 7-10 (done)

link
* [[토크ON세미나] 자연어처리-자연어처리에 대한 이해][understanding_nlp]

[understanding_nlp]: https://tacademy.sktechx.com/live/player/onlineLectureDetail.action?seq=108

## May 25

reading
* (science bites) [a fortunate universe][a_fortunate_universe] chapter 3-4

link
* Facebook open source
 * [Prepack][prepack] - optimizes JavaScript source code
 * [SwiftTweaks][swifttweaks] - adjusts your Swift-based iOS app without needing to recompile
 * [hblog][hblog] - log parser for clusters
 * [Mcrouter][mcrouter] - memcached protocol router for scaling memcached deployments

[prepack]: https://prepack.io/
[swifttweaks]: http://engineering.khanacademy.org/posts/introducing-swifttweaks.htm
[hblog]: https://github.com/facebook/hblog
...
reading
* (science bites) [a fortunate universe][a_fortunate_universe] chapter 5
* (science bites) [systematic][systematic] chapter 1-3
...
reading
* (science bites) [systematic][systematic] chapter 4

## May 31

personal
* (video) [GOTO 2017 • The Many Meanings of Event-Driven Architecture • Martin Fowler](https://www.youtube.com/watch?v=STKCRSUsyP0), [article](https://martinfowler.com/articles/201701-event-driven.html)
 * 1) Event Notification 2) Event-carried State Transfer 3) Event Sourcing 4) CQRS (Command Query Responsibility Segregation, operational database vs reporting database)

reading
* (science bites) [systematic][systematic] chapter 5
* (science bites) [fundamentals of physics.md][fundamentals_of_physics.md] chapter 1
...
* [JetBrains Spring 세미나](https://www.jetbrains.com/kr/jetbrains-spring-seminar-2017/) (판교) 5월 19일 (금) 14시 00분 ~ 18시 00분 ([동영상](https://www.youtube.com/playlist?list=PLQ176FUIyIUbm3X1Sq0OCVwAenohgN0vd))
...
* [코딩이랑 무관한 Azure 파트 소개 (오픈스택+코딩이랑 무관합니다만, 공동 밋업)](http://onoffmix.com/event/101353) 5월 31일 (수) 19시 00분 ~ 21시 30분
...
* [Advanced Neurobiology I](https://www.coursera.org/learn/advanced-neurobiology1) from May 29 to Jul 23
* [Using Open Data for Digital Business](https://www.futurelearn.com/courses/open-data-business) from May 29 to Jun 18
