 ...
 * previous meetings - (2015) Sep 24, Oct 1, Oct 8, Oct 22, Oct 30, Nov 6, Nov 19, Dec 10, Dec 30, (2016) Jan 6, Jan 27, Feb 11, Feb 24, Mar 17
...
link
* [정보시각화란 무엇인가 - D3.js가 시각화에 있어서 중요한 이유][information_visualization]
...
reading
* [peopleware][agile_repo] chapter 36
* [learn you a haskell for great good][learn_you_a_haskell_for_great_good] chapter 10

## May 20

reading
* [peopleware][agile_repo] chapter 37
...
reading
* [peopleware][agile_repo] chapter 38

## May 24

reading
* [peopleware][agile_repo] chapter 39 (end)
...
link
* Apache Zeppelin is promoted as a top-level project. ([blog][zeppelin_toplevel])

[zeppelin_toplevel]: https://blogs.apache.org/foundation/entry/the_apache_software_foundation_announces92
...
reading
* [an introduction to agent based modeling][introduction_to_agent_based_modeling] chapter 0

[introduction_to_agent_based_modeling]: ../reading/introduction_to_agent_based_modeling.md

link
* [Statistics for everyone][fathers_tutor] "아빠가 들려주는 ..." 블로그

[fathers_tutor]: http://statistics4everyone.blogspot.kr/
...
reading
* [linux kernel networking][linux_kernel_networking] chapter 1

[linux_kernel_networking]: linux_kernel_networking.md
...
* :paw_prints: [하스켈 학교 해커톤](http://onoffmix.com/event/68424) 5월 24일 (화) 19시 00분 ~ 22시 00분
...
* [오픈 데이터 시각화 세미나!!](http://onoffmix.com/event/67848) 5월 27일 (금) 14시 00분 ~ 17시 00분
...
* [오픈소스 데이터센터 포럼 두 번째 스터디 모임](http://onoffmix.com/event/69098) 5월 31일 (화) 20시 00분 ~ 22시 00분
...
* [Tropical Coastal Ecosystems](https://www.edx.org/course/tropical-coastal-ecosystems-uqx-tropic101x-2) from May 31 (self-paced) to Jul 18
